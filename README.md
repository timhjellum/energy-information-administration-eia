...
* Clone the repository [https://github.com/timhjellum/eia---case-study](git clone https://github.com/timhjellum/boston-market---case-study.git)
* `cd eia---case-study`
* `npm install`
* `run npm start`